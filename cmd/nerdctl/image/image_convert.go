...
func convertCommand() *cobra.Command {
	...
	// #region soci flags
	cmd.Flags().Bool("soci", false, "Convert image to SOCI format. Should be used in conjunction with '--oci'")
	cmd.Flags().Int64("soci-min-layer-size", -1, "The minimum size of layers that will be converted to SOCI format")
